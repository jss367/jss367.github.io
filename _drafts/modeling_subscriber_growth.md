...
| γ<sub>step</sub> | Permanent level shift | 50 – 2,000 | New baseline after paywall change, rebrand, or cross-promotion |
| γ<sub>exog</sub> | Slope for numeric regressor xₜ. THIS IS WHERE THE VALUE OF ADS COMES IN | depends on scaling | e.g., +5 subs per $100 ad spend |
