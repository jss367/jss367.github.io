...
This post walks through how to create a Siamese network using FastAI. It is based on [a tutorial from FastAI](https://docs.fast.ai/tutorial.siamese.html), so some of the classes and function are directly copied from there, but I've added things as well.
