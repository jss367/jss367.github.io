...
alias fwrd='grep -rnw . -e'
alias ftxt='grep -rn . -e'
...
# Custom Paths
export PATH=/Users/juliussimonelli/apache-maven-3.8.1/bin:$PATH
export PYTHONPATH=$PYTHONPATH:/Users/juliussimonelli/git/votesim
...
source .credentials # Add passwords and other credentials
```
