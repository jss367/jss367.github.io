...
You can look at the configuration in your `.zshrc` file.
* I usually leave this file alone, but you can customize the theme if you want.
* Then I create a file that just says `source ~/.profile` and save it at `~/.oh-my-zsh/custom/profile.zsh`
  * That links to `~/.profile`, which is where I keep all my custom configurations
